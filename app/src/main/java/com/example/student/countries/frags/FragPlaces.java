...
public class FragPlaces extends Fragment {
    ...
    public static FragPlaces newInstance(String param1, String param2) {
        FragPlaces fragment = new FragPlaces();
    ...
    public static FragPlaces getInstance(String param1, String param2) {
